...
The fact that this definition does not depend on the choice of $\beta$ can be checked using the Hall--Witt identity (notice that we can further decompose $x_{\alpha-\beta}(t^2b)$ into a commutator in $\St(\Phi, tR)$).
