...
\begin{proof}  
 ...
 \begin{proof} Consider the following commutative diagram
	 \[\xymatrix{\St(\Phi, R) \ar[r]^{\rho_\St} \ar[d]^{\mathrm{st}_R} & \St(\Phi, R/I) \ar[d]^{\mathrm{st}_{R/I}} \\ \mathrm{E}_{\mathrm{sc}}(\Phi,R) \ar[r]^{\rho_\mathrm{E}} & \mathrm{E}_{\mathrm{sc}}(\Phi, R/I).}\]
	 We denote by $\St(\Phi, R, I)$ the normal closure in $\St(\Phi, R)$ of the subgroup generated by elements $x_\alpha(s)$, where $s\in I$, $\alpha\in\Phi$. We also denote by $\E_{\mathrm{sc}}(\Phi, R, I)$ the image of this subgroup under $\mathrm{st}_R$. Denote by $H$ the preimage of $\mathrm{K}_2(\Phi, R/I)$ under $\rho_\St$. Also set $H'=[H, \St(\Phi, R)]$. Standard commutator identities show that $H'$ is a normal subgroup of $\St(\Phi, R)$. Under our assumptions the group $\St(\Phi, R)$ is perfect, therefore using Hall--Witt identity we obtain that
	 \begin{multline}\nonumber H' = [H,\, \St(\Phi, R)] = [H,\, [\St(\Phi, R), \St(\Phi, R)]] \subseteq \\ \subseteq [[H,\, \St(\Phi, R)],\, \St(\Phi, R)] = [H', \St(\Phi, R)]. \end{multline} 
		 Since $\mathrm{st}_{R}(H)$ is contained in the congruence subgroup $\GG_\mathrm{sc}(\Phi, R, I)$ we obtain from the standard commutator formula~\cite{Va86} that $\mathrm{st}(H')\subseteq\E_\mathrm{sc}(\Phi, R, I)$. Thus, $H'\subseteq \St(\Phi, R, I) \cdot \mathrm{K}_2(\Phi, R)$. Finally, from our assumptions we obtain that
	 \[H' \subseteq [H', \St(\Phi, R)] \subseteq [\St(\Phi, R, I)\mathrm{K}_2(\Phi, R),\, \St(\Phi, R)] \subseteq \St(\Phi,R,I),\]
