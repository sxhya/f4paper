...
As a corollary, we obtain that Stein's $\mathrm K_2$-group $\mathrm{K}_2(\Phi, R)$ defined as the the kernel of the homomorphism~\eqref{eq:st} coincides with the unstable $\mathrm{K}_2$-group defined via Quillen's $+$-construction applied to the perfect subgroup $\mathrm{E}_{sc}(\Phi, R)$: \[\mathrm{K}_2(\Phi, R) \cong \mathrm{K}_2^Q(\Phi, R) := \pi_2\mathrm{BG}_{sc}(\Phi,\,R)^+_{\mathrm{E}_{sc}(\Phi, R)}.\] The latter group coincides with the second homology group $\mathrm H_2(\mathrm E_{sc}(\Phi,\,R),\,\mathbb Z)$; see e.\,g.~\cite[\S~IV.1]{Weibel}.
...
It is an easy exercise that the kernel of $\varphi$ is a central subgroup of $M$, while the image 
