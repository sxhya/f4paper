...
\begin{equation} \label{eq:bis} \begin{aligned} \xymatrix{ \{y_i\} \ar@<3.5pt>[r]^(0.4){\{b_i\}} \ar@<-3.5pt>[r]_(0.4){\{b_i'\}} \ar@{^{(}->}[d] & \tfrac R {s_1} \otimes K \ar[rd] \ar[rr]^{s_2\otimes \mathrm{id}} & & \tfrac R {s_1 s_2} \otimes K \ar[ld] \\ K \ar[rr]^(.4){(g\otimes \mathrm{id})\circ \mathrm{Coconj}} & & S^{-1} R \otimes K. }\end{aligned} \end{equation}
