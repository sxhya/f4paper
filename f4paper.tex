...
%Recall from~\cref{sec:group-objects} that it is enough to check that it is morphism of group objects in \(\Pro(\Set)\).
...
The commutativity of the whole diagram now gives the identity $\up g (h_1h_2) = \up g h_1 \cdot \up g h_2$.
