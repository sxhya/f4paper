...
\begin{proof}
 ...
 for some Loran polynomials \(P_{i, j}(a) \in \mathbb Z[a, a^{-1}]\) depending only on \(\alpha\) and \(\beta\). But then in the Steinberg group \(\St(\Phi, \mathbb Z[a, a^{-1}])\) we have the identity
