...
\begin{proof} 
 ...
 Now let \(\beta, \gamma \in \Phi \setminus \{\pm \alpha\}\) be a pair of nonparallel roots. %there is Steinberg relation for \([x_\beta(b^{(\infty)}), x_\gamma(c^{(\infty)})]\) in \(\St^{(\infty)}(\Phi \setminus \{\pm \alpha\}, R)\). 
 Consider the ``universal'' identity
 ...
 in \(\St(\Phi, \mathbb Z[b, c, t])\), where \(N_{\beta, \gamma}^{1, 1} = N_{\beta, \gamma}\) and \(N_{\beta, \gamma}^{1, 2} = -N_{\gamma, \beta}^{2, 1}\). This identity is a consequence of the defining relations of \(\St(\Phi \setminus \{\pm \alpha\}, \mathbb Z[b, c, t])\) and the Steinberg relations for \([x_\alpha(t), x_\delta(d)]\), where \(\delta \in \Phi \setminus \{\pm \alpha\}\) and \(d \in b \mathbb Z[b, c, t] + c \mathbb Z[b, c, t]\). Applying the pro-analogs of these relations, we get
