...
\usepackage{enumitem}
%\usepackage[backend=bibtex, bibencoding=utf8, giveninits=true, citestyle=numeric-comp, sorting=nyt, sortlocale=en_US, url=false, doi=false, eprint=true, maxbibnames=4]{biblatex}
...
\textit{Algebra: Some Recent Advances, Birkh{\"a}user Basel} (1999): 41--62.

\bibitem{CTO92}
Colliot-Th{\'e}l{\`e}ne, J.-L., and M. Ojanguren.
\href{http://www.numdam.org/article/PMIHES_1992__75__97_0.pdf}{``Espaces principaux homog{\`e}nes localement triviaux.''}
\textit{Publ. Math. IH{\'E}S} 75 (1992): {97--122}.

\bibitem{Ho05}
Hornbostel, J.
\href{http://dx.doi.org/10.1016/j.top.2004.10.004}{``$\mathbb{A}^1$-representability of Hermitian K-theory and Witt groups.''}
\textit{J. Top.} {44} no. {3} (2005): {661--687}.  
...
\bibitem{SK06}
Kashiwara, H., and P. Schapira.
``Sheaves and categories''.
\textit{Springer Berlin} (2006).
...
\href{https://arxiv.org/abs/2009.03999}{``Centrality of $K_2$ for Chevalley groups: a pro-group approach.''}
(2021).

\bibitem{Li81}
Lindel, H.
\href{http://eudml.org/doc/142853}{``On the Bass-Quillen conjecture concerning projective modules over polynomial rings.''}
\textit{Inv. Math.} 65 no. 2 (1981): 319--323.  

\bibitem{Ma69}
Matsumoto, H.
\href{http://eudml.org/doc/81843}{``Sur les sous-groupes arithm{\'e}tiques des groupes semi-simple d{\'e}ploy{\'e}s.''}
\textit{Ann. Sci. ENS}, 2 no. 1 (1969): {1--62}.

\bibitem{May67}
May, J.P.
``Simplicial objects in algebraic topology.''
\textit{Univ. Chicago Press} (1967).

\bibitem{Mi80}
Milne, J.S.
``{\'E}tale Cohomology.''
\textit{Princeton Univ. Press} (1980).

\bibitem{MV99}
Morel, F., and V. Voevodsky.
\href{http://www.numdam.org/item/PMIHES_1999__90__45_0/}{``$\mathbb{A}^1$-homotopy theory of schemes.''}
\textit{Publ. Math. IH{\'E}S} {90} (1999): {45--143}.

\bibitem{MS20}
Morel, F., and S. Anand.
\href{https://arxiv.org/abs/2007.14770}{``Cellular $\mathbb{A}^1$-homology and the motivic version of Matsumoto's theorem.''}
({2020}).
...
\bibitem{Re75}
Rehmann, U.
\href{http://www.math.uni-bielefeld.de/~rehmann/Publ/praesentation.pdf}{`` Pr{\"a}sentationen von Chevalleygruppen {\"u}ber $k[t]$.''}
(1975).
...
\bibitem{St67}
Steinberg, R.
\textit{Yale Univ. New Haven} (1967).

\bibitem{Su82}
Suslin, A.
\href{http://dx.doi.org/10.1007/BFb0062181}{``Stability in algebraic $\K$-theory.''}
\textit{Algebraic K-Theory} (1982): {304--333}.

\bibitem{Sw98}
Swan, R.
\href{https://academic.hep.com.cn/qb/EN/chapter/9781571462428/chapter08}{``N{\'e}ron--Popescu desingularization.''}
\textit{Algebra and geometry (Taipei, 1995) Int. Press Cambridge, MA} 2 (1998): 135--192.
...
\href{https://arxiv.org/abs/2003.07230}{``Commutators of relative and unrelative elementary subgroups in Chevalley groups.''}
(2020).
...
\textit{Amer. Math. Soc., Grad. Texts Math.} 145 (2013).  
...
%\bibitem{HOM}
%Hahn, A.J., and T. O'Meara.
%``The classical groups and $\K$-theory.''
%\textit{Springer} (1989).
  
%\bibitem{Po90}
%Popescu, D.
%\href{http://dx.doi.org/10.1017/S0027763000002981}{``Letter to the editor: General N{\'e}ron desingularization and approximation.''}
%\textit{Nagoya Math. J.} 118 (1990): 45--53.
  
%\bibitem{V20}
%Voronetsky, E.
%\href{https://arxiv.org/abs/2005.02926}{``Centrality of odd unitary $\K_2$-functor.''}
%\textit{Comm. Alg.} (to appear). 
  
%\bibitem{Vo81}
%Vorst, T.
%\href{http://dx.doi.org/10.1080/00927878108822596}{``The general linear group of polynomial rings over regular rings.''}
%\textit{Comm. Alg.} 9 no. 5 (1981): 499--509.
