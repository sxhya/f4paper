...
% Author name(s)
\author{Andrei Lavrenov\affil{1}$\!\,^{,}$\affil{2}, Sergey Sinchuk\affil{2} and Egor Voronetsky\affil{2}}
...
\address{%
\affilnum{1}Bar-Ilan University, 5290002 Ramat Gan, Israel\\
\affilnum{2}St. Petersburg State University, 14th Line V.O. 29B, 199178 St. Petersburg, Russia
%and
...
\bibitem{vdK77}van der Kallen, W. \href{http://www.numdam.org/item/?id=ASENS_1977_4_10_4_473_0}{``The $\K_2$ of rings with many units''}, \textit{Ann. Sci. {\'E}c. Norm. Sup{\'e}r.} 10:4 (1977) 473–515.
...
\bibitem{Li81} Lindel, H. \href{http://eudml.org/doc/142853}{``On the Bass--Quillen conjecture concerning projective modules over polynomial rings.''} \textit{Invent. Math.} 65, no. 2 (1981): 319--323.  
