...
% Author name(s)
\author{Andrei Lavrenov\affil{1}$\!\,^{,}$\affil{2}, Sergey Sinchuk\affil{1} and Egor Voronetsky\affil{1}}
...
\address{%
\affilnum{1}St. Petersburg State University, 14th Line V.O. 29B, 199178 St. Petersburg, Russia\\
\affilnum{2}Bar-Ilan University, 5290002 Ramat Gan, Israel
%and
