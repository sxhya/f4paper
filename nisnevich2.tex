...
\title{On the $\mathbb{A}^1$-invariance of $K_2$ modeled on Chevalley groups.}
...
\begin{theorem}[The $\K_2$-analogue of Lindel--Popescu theorem]
 Lol
\end{theorem}


\begin{theorem}[The $\K_2$-analogue of Gerstein conjecture]
...
\subsection{Preliminaries on Steinberg groups}
\begin{align}
