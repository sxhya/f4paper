...
\subsection{Acknowledgements} The authors would like to thank A. Stavrova for suggesting several ideas used in this paper. We would also like to thank P.~Gvozdevsky, S.~Ivanov, V.~Sosnilo and N.~A.~Vavilov for their useful comments and interest in this work.
...
\begin{proof}[Proof of~\cref{cor:various-facts}]
 ...
 \begin{proof}[Proof of~\cref{cor:H_2-O}]
  ...
  Writing the inflation/restriction sequence associated with the homological Lyndon--Hochschild--Serre spectral sequence of $\mathrm{EO}_{2\ell}(R) \hookrightarrow \mathrm{O}_{2\ell}(R) \twoheadrightarrow \mathrm{KO}_{1, 2\ell}(R)$ we obtain an exact sequence
